...
def get_test_input():
    ...
    img = cv2.resize(img, (608, 608))            # 608x608 for YOLOv4
...
def create_modules(blocks):
    ...
    for index, x in enumerate(blocks[1:]):
        ...
        if (x["type"] == "convolutional"):
            ...
            kernel_size = int(x["size"])
            stride = int(x["stride"])
            maxpool = nn.MaxPool2d(kernel_size, stride, padding=kernel_size//2)
        ...
        #If it is a route layer
            ...
            # normalize to absolute indices
            layers = [index + l if l < 0 else l for l in layers]
            
            # sum filters from all layers
    ...
    def forward(self, x, CUDA):
        ...
        for i, module in enumerate(modules):        
            ...
            if module_type == "convolutional" or module_type == "upsample" or module_type == "maxpool":
                ...
                # normalize all indices to absolute positions
